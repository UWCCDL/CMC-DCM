...
The mean correlation between tasks parameters is `r mean(withinTaskMeans$meanR)`, with range `r range(withinTaskMeans$meanR)`. The mean correlation of Resting State with task data is `r restingStateMeans`, which is well within the range.
